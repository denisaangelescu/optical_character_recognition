...
output_base = r"C:\Users\denis\Desktop\sample_images\detectie\fara_filtre"

# Lista detectorilor disponibili
detectors = ["maskrcnn"]
# ["dbnet", "dbnetpp", "drrg", "fcenet", "maskrcnn", "psenet", "textsnake"]
# panet
    ...
    if image_files:  # Verifica daca exista cel putin o imagine in folder
        ...
        for detector in detectors:
            ...
            try:
                ...
                # Verifică dacă inferența a returnat un rezultat valid
                if result is None or 'visualization' not in result or not result['visualization']:
